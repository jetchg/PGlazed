...
<head>
<meta http-equiv="origin-trial" content="">
<meta charset="utf-8">
<meta http-equiv="x-ua-compatible" content="ie=edge">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="description" content>
<title>Pokemon Glazed 9.0</title>
...
<script>
    if (window.top == window) {
        ...
        document.location.href = 'https://www.retrogames.cc/gameboyadvance-games/pokemon-glazed-9-0.html';
    }
</script>
...
<h1 class="title" style="font-size:24px">Great to have you back!</h1>
<div class="content">
...
<li><a href="#">Browser Storage</a></li>
...
<a class="button primary submit tiny" data-close tabindex="0">Yes</a>
<a class="button tiny cancel" data-close tabindex="0">No</a>
</div>
</div>
</div>
...
<script>
    ...
    $(function() {
        ...
        loadModal.on('click', '.state-item-db img', function() {
            var id = $(this).data('id');
        ...
        .on('drop', function(e) {
            ...
            filereader.readAsArrayBuffer(files[0]);
                ...
                EJS_player = '#game';
    EJS_gameUrl = 'https://filesus3.retrogames.cc/MndKa1p4VnJhWlZsbTVScENSVmxhWnRsWitiY2xDN1gxTmpXbUlJblcybFVNS2hlTDJnQVV5VXNLb2NMRGo4Q015UW9aS2N5WjJQUmkzUW4%3D/glazed-9.0.7z';
    EJS_gameID = 42911;
    EJS_core = 'gba';
    EJS_biosUrl = '/bios/gba.7z';
    ...
    var stateDB = new Dexie("retrogames-states");
    stateDB.version(1).stores({
        states: "++id,game_id,state,screen"
    });
    

    var getStatesFromDB = function() {
        stateDB.states.where({"game_id": 42911}).reverse().limit(6).toArray().then(function(states) {
    ...
    var saveStateToDB = function(screenshot, state) {
        stateDB.states.add({game_id: 42911, 'state': state, 'screen': screenshot}).then(function() {
            $.toast({
                text : "Saved",
    ...
    var saveStateToLocal = function(screenshot, state) {
        if (typeof saveAs != 'undefined') {
            saveAs(new Blob([state], {type:"application/octet-stream"}), 'glazed-9.0.save');
        }
    };
...
$(function() {
    setTimeout(function() {
        // $('.EJS_73f9b4e94a7a1fe74e11')[0].click();
        
        if ($('.ejs--73f9b4e94a7a1fe74e11107d5ab2ef').length && !(/iPhone|iPad|iPod/i.test(navigator.userAgent || ''))) {
            // $('.ejs--73f9b4e94a7a1fe74e11107d5ab2ef')[0].click();
        }
    }, 1000);
});
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-41540658-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-41540658-3');
</script>
</body>
</html>
